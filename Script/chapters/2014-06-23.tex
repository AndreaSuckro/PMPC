...
\begin{align*}
  ...
  &= \underbrace{P\left(R=old|Memory=old\right)}_{1} \underbrace{P\left(M=old|S=old\right)}_{P_r} + \underbrace{P\left(R=old|M=new\right)}_q \underbrace{P\left(M=new|S=old\right)}_{1-P_r}\\
