...
This can be done by integration of the PDF\index{PDF}: 
...
\end{axis}
\end{tikzpicture}
\caption{Gaussian distributions with $\mu=0$ and $\sigma = 0.5, 1, 2$, and $\mu=1, \sigma=1$.}
\label{fig:2014-05-09-diffGaussDistr}
\end{figure}

The corresponding integral is $\Phi$ (see figure \ref{fig:2014-05-09-diffGaussInts}).
...
\end{axis}
\end{tikzpicture}
\caption{Integrals of Gaussian distributions with $\mu=0$ and $\sigma = 0.5, 1, 2$, and $\mu=1, \sigma=1$.}
\label{fig:2014-05-09-diffGaussInts}
\end{figure}
