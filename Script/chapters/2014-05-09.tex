...
\begin{tikzpicture}
  ...
  % first box
  \draw[thick] (1.0, 0.0) parabola (1.25, 0.1) parabola (1.75, 0.3) parabola (2.25, 1.2);
  \draw[thick] (1.5, 0) -- (1.5, 0.3) -- (2.0, 0.3) -- (2.0, 0);
  % second box
  \draw[thick] (2.0, 0) -- (2.0, 1.2) -- (2.5, 1.2) -- (2.5, 0);
  \draw[thick] (2.5, 0) -- (2.5, 1.6) -- (3.0, 1.6) -- (3.0, 0);
  % third box
  \draw[thick] (3.0, 0) parabola[bend at end] (3.5, 0.45);
  \draw[thick] (3.5, 0) -- (3.5, 0.35) parabola[bend at end] (4.0, 0.35) -- (4.0, 0);
