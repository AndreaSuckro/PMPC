...
Note that there is a difference between coherence\index{Coherence} and calibration\index{Calibration}, for example you might believe p=0.5, but it is really 0.4. Then you would be coherent but not well calibrated, as you can see from the expected value: $E: 0.5 \cdot 0.4 - 0.5 \cdot 0.6 = -0.1$.
