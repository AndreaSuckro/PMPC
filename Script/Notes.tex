...
%\begin{filecontents*}{histogramToPDFExample.data}
  %\input{test.txt}
%\end{filecontents*}
...
% Practice: Bayesian and Frequentist Inference I
\iftoggle{exercises}{
  \includepdf[pages={-},
      addtotoc={1,section,1,Tutorial Sheet 4: Bayesian and Frequentist Inference I,exsheet4},
      viewport=100 50 550 700,
      scale=0.75,
      pagecommand=\thispagestyle{plain}
...
% Practice: Bayesian and Frequentist Inference II
\iftoggle{exercises}{
  \includepdf[pages={-},
      addtotoc={1,section,1,Tutorial Sheet 5: Bayesian and Frequentist Inference II,exsheet5},
      viewport=100 50 550 700,
      scale=0.75,
      pagecommand=\thispagestyle{plain}
