...
\usepackage[T1]{fontenc}      % font encodin

\usepackage{tikz}      % difficult diagrams
...
\iftoggle{exercises}{
  \includepdf[pages={-},
      addtotoc={1,section,1,Tutorial Sheet 1,exsheet1},
...
\iftoggle{exercises}{
  \includepdf[pages={-},
      addtotoc={1,section,1,Tutorial Sheet 2,exsheet2},
      viewport=100 50 550 700,
      scale=0.75,
      pagecommand=\thispagestyle{plain}
...
\iftoggle{exercises}{
  \includepdf[pages={-},
      addtotoc={1,section,1,Tutorial Sheet 3,exsheet3},
      viewport=100 50 550 700,
      scale=0.75,
      pagecommand=\thispagestyle{plain}
