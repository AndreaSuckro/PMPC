...
\end{align*}
We may also adapt on the variance by dividing through $\delta$, thus arriving on a Gaussian with variance $\delta = 1$ and mean $\mu = 0$ in statistics this is called standardising or normalising.
\begin{align*}
