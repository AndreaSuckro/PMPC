...
% alpha/beta prior from sheet
alphaPrior = 1;
betaPrior  = 9;

% derived posterior alpha/beta
alphaPosterior = 231;
betaPosterior  = 279;
...
% print x-values
['Low: ' num2str(x(intersectionLow))]
['High: ' num2str(x(intersectionHigh))]
...
%csvwrite('output/posteriorPDFArea.txt',[x(intersectionLow:intersectionHigh)' yPosteriorPDF(intersectionLow:intersectionHigh)']);
